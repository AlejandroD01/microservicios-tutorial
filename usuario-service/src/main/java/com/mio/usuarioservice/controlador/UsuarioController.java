package com.mio.usuarioservice.controlador;
...
import com.mio.usuarioservice.servicio.UsuarioService;
...
public class UsuarioController {
	...
	public ResponseEntity<Moto> guardarMoto(@PathVariable("usuarioId") int usuarioId,@RequestBody Moto moto){
		System.out.println("controller: id usuario:"+usuarioId + " la moto: "+ moto.getMarca());
